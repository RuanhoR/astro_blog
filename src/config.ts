...
export const siteConfig: SiteConfig = {
	title: "Ruanhor Blog",
	subtitle: "Blog Website Powered by Fuwari",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/RuanhoR/astro_blog", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://space.bilibili.com/3546582465120608",
		},
		{
			name: "Github",
		...
		},
		{
			...
			url: "mailto:root@ruanhor.dpdns.org"
		},
		{
			name: "QQ",
			icon: "fa6-brands:qq",
