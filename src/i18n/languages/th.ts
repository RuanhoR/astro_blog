...
export const th = {
  ...
  [Key.drawingTool]: 'เครื่องมือวาด',
  [Key.brush]: 'แปรง',
  [Key.colorPicker]: 'เลือกสี',
  [Key.shape]: 'รูปทรง',
  [Key.imageImport]: 'นำเข้ารูปภาพ',
  [Key.brushType]: 'ประเภทแปรง',
  [Key.fringe]: 'ขอบ',
  [Key.backgroundColor]: 'สีพื้นหลัง',
  [Key.foregroundColor]: 'สี前景',
  [Key.natDetection]: 'ตรวจจับ NAT',
