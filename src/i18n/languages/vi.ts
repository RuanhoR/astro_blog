...
export const vi = {
  ...
  [Key.drawingTool]: 'Công cụ vẽ',
  [Key.brush]: 'Cọ',
  [Key.colorPicker]: 'Chọn màu',
  [Key.shape]: 'Hình dạng',
  [Key.imageImport]: 'Nhập hình ảnh',
  [Key.brushType]: 'Loại cọ',
  [Key.fringe]: 'Viền',
  [Key.backgroundColor]: 'Màu nền',
  [Key.foregroundColor]: 'Màu tiền cảnh',
  [Key.natDetection]: 'Phát hiện NAT',
